...
class FontVariables
{
	...
	public function __construct()
	{
		$this->defaults = [
			...
			'backupSubsFont' => ['Montserrat', 'dejavusanscondensed', 'freesans', 'sun-exta'],
			...
			'sans_fonts' => ['dejavusanscondensed', 'Montserrat', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
