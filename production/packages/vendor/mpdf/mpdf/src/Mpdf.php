	...
	function Output($name = '', $dest = '')
	{
		...
		switch ($dest) {
			...
			case Destination::FILE: 
				// antes o arquivo aberto usava a seguinte função: substr($name, 3). Caso ocorra algum erro no path pode ser que o erro esteja relacionado a essa remoção -> Yann
				$f = fopen($name, 'wb');
